...
int \mbox{\hyperlink{action_8c_a45a1e9c65df672dbf7e6b5f19220f88c}{find\+End\+Point}} (int index, unsigned int user\+ID, int status, struct \mbox{\hyperlink{structAction}{Action}} $\ast$actions, int number\+Of\+Actions)
...
\end{DoxyReturn}
\mbox{\Hypertarget{action_8c_a45a1e9c65df672dbf7e6b5f19220f88c}\label{action_8c_a45a1e9c65df672dbf7e6b5f19220f88c}} 
\index{action.c@{action.c}!findEndPoint@{findEndPoint}}
\index{findEndPoint@{findEndPoint}!action.c@{action.c}}
